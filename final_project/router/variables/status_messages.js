const STATUS_MESSAGE = {
  ...
  100: {
    message: "Continue",
    description: "Server received request headers, client should send body",
  },
  101: {
  ...
  102: {
    message: "Processing",
    description: "Server is processing request (WebDAV)",
  },
  103: {
    message: "Early Hints",
    description: "Server is returning some headers before final response",
  },
  ...
  203: {
    ...
    description: "Transformed response from proxy",
  },
  204: { message: "No Content", description: "Success but no response body" },
  205: {
    message: "Reset Content",
    description: "Client should reset document view",
  },
  206: {
    message: "Partial Content",
    description: "Partial response to range request",
  },
  207: {
    message: "Multi-Status",
    description: "Multiple status codes for WebDAV",
  },
  208: {
    message: "Already Reported",
    description: "WebDAV binding members already listed",
  },
  ...
  300: {
    ...
    description: "Multiple options for resource representation",
  },
  301: {
  ...
  307: {
    ...
    description: "Repeat request with same method",
  },
  308: {
    message: "Permanent Redirect",
    description: "Permanently redirect with same method",
  },
  ...
  407: {
    ...
    description: "Client must authenticate with proxy",
  },
  ...
  412: {
    ...
    description: "Request conditions not met",
  },
  413: {
    message: "Payload Too Large",
    description: "Request exceeds size limits",
  },
  ...
  416: {
    ...
    description: "Can't satisfy Range header",
  },
  417: {
    message: "Expectation Failed",
    description: "Can't meet Expect header",
  },
  418: {
  ...
  421: {
    ...
    description: "Server can't produce response",
  },
  422: {
    message: "Unprocessable Entity",
    description: "Semantic request errors",
  },
  423: { message: "Locked", description: "Resource is locked (WebDAV)" },
  424: {
    message: "Failed Dependency",
    description: "Request depended on failed request",
  },
  425: { message: "Too Early", description: "Risk of request replay" },
  426: {
    message: "Upgrade Required",
    description: "Client must switch protocols",
  },
  428: {
  ...
  503: {
    ...
    description: "Server temporarily overloaded",
  },
  ...
  506: {
    ...
    description: "Circular content negotiation",
  },
  507: {
    message: "Insufficient Storage",
    description: "Storage space issue (WebDAV)",
  },
  508: {
  ...
  511: {
    ...
    description: "Client needs network authentication",
  },
};
